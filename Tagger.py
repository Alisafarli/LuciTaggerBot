...
async def start(event):
  await event.reply("**🇦🇿👨‍💻 Krakadiltaggerbot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
		      ...
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/HASBULLATaggerbot?startgroup=a')],
                      [Button.url('Support🛠', 'https://t.me/Botsssupport')],
                      [Button.url('Resmi Kanal📣', 'https://t.me/HasbullaMMC')],
		      [Button.url('SAHİBİM👨🏻‍💻', 'https://t.me/Hasbulllahh')],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**🇦🇿👨‍💻 HASBULLATaggerbot Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
...
async def help(event):
  helptext = "**Çok özellikleri Etiket Botu Bulmaya Çalışan Grub Sahibleri @CrstalTaggerbot Size Göre:\n\n📌 5-li etiket\n📌 Emoji etiket\n📌 Tekli Etiket\n📌 Yalnız Yöneticileri etiketleme\n📌\n\n Böyle Çok özellikli @LuciTaggerBot 'u grubunuza yönetici olarak ekleyip rahatlıkla üyelir , etiket ata bilirsiz **"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/HASBULLATaggerbot?startgroup=a')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalışıyor merak etme 🚀 @Botsssupport bilgi alabilirsin <<")
