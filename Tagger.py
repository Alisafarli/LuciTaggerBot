...
async def start(event):
  await event.reply("**🇦🇿👨‍💻 Krakadiltaggerbot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
		      ...
		      [Button.url('Beni Gruba Ekle ➕', 'https://t.me/KrakadilTaggerbot?startgroup=a')],
                      ...
                      [Button.url('Resmi Kanal📣', 'https://t.me/KrakadilResmi')],
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Botu Gruba Ekle➕', 'https://t.me/Krakadilaggerbot?startgroup=a')],
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalışıyor merak etme 🚀 @Krakadilsupport bilgi alabilirsin <<")
